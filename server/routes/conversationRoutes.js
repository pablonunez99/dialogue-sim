...
import {
  loadHistory, saveHistory, loadNpcs, saveNpcs, loadLocations, saveLocations, loadEvents,
  findPath, CONNECTIONS
} from '../data/repository.js';
import { addMinutesToTime, getTimeOfDay } from '../world/time.js';
import { getEligibleEvent, triggerBackgroundEvents, generateSingleQuestOnTheFly } from '../world/eventEngine.js';
...
import { geminiClient, geminiModel, openaiClient, openaiModel, client, modelName, useGemini, defaultProvider } from '../config/aiProviders.js';
import { ConversationManager } from '../conversationManager.js';
import { generateNpcPortraits, generateLocationBackground } from '../images/portraitGenerator.js';
import { syncNpcToVectorDb, syncLocationToVectorDb } from '../vectorSync.js';
